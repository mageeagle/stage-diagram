      ...
      <main className="relative flex-1">
        ...
        <div className="absolute top-4 right-4 flex items-center gap-2 z-10000">
          ...
          <button
            ...
            className="cursor-pointer p-2 rounded-md bg-white dark:bg-stone-800 shadow-md border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-700 transition-colors z-50"
          >
            <Settings size={20} />
          </button>
        </div>
